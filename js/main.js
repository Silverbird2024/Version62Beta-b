...
$scope.TNeoAppPage11_pageenter = function() {$App.M002x001 = localStorage.getItem("M002x001");};
...
$scope.SelectionM016_pageenter = function() {$App.M016x001 = localStorage.getItem("M016x001");};
...
$scope.PushButton35_click = function() {$App.Main = "Time";
...
$scope.PushButton38_click = function() {$App.Main = "Work";
...
$scope.GotoPage( "SelectionM001" );};
$scope.PushButton39_click = function() {$App.Main = "Time";
...
$scope.PushButton47_click = function() {$scope.GotoPage( "SelectionM016" );};
...
$scope.PushButton9_click = function() {$scope.GotoPage( "BounceMain" );};
...
$scope.PushButton79_click = function() {$scope.GotoPage( "SelectionM001x06" );};
...
$scope.TextArea10_change = function() {localStorage.setItem("M003x001",$App.M003x001);};
...
NeoApp.controller("SelectionM016_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 54;
$App.NAB.PageID = "SelectionM016";
$scope.PushButton50_click = function() {$scope.GotoPage( "Main" );};
$scope.TextArea8_change = function() {localStorage.setItem("M016x001",$App.M016x001);};
});
